  ...
  return (
    <div className="App min-h-screen">
      ...
      <div aria-hidden="true" className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute max-w-none object-50%-50% object-cover opacity-20 size-full bg-[url('https://res.cloudinary.com/ds5kihtow/image/upload/v1761401615/library-static/background.jpg')] bg-cover bg-center bg-fixed" />
      </div>
